...
build_model \
    -cell	 rr_arbiter \
    -techlib	 /home/M24_2/cadence_edt/HMK_VDA/mokesh_project_test_arbiter/dft_insertion_for_scan_chain//dft_input/slow.lib \
    -designsource	 $WORKDIR/rr_arbiter.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/rr_arbiter.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 rr_arbiter_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_rr_arbiter_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 rr_arbiter_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_rr_arbiter_atpg
...
check_log log_commit_tests_FULLSCAN_rr_arbiter_atpg
