...
# Generated on: Wed Mar 25 02:13:07 IST 2026 (Tue Mar 24 20:43:07 UTC 2026)
...
set logfile fv/rr_arbiter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/rr_arbiter -revised fv_map
...
add_search_path /home/M24_2/cadence_edt/HMK_VDA/mokesh_project_test_arbiter/dft_insertion_for_scan_chain/dft_input -library -both
read_library -liberty -both \
    /home/M24_2/cadence_edt/HMK_VDA/mokesh_project_test_arbiter/dft_insertion_for_scan_chain/dft_input/slow.lib
...
add_search_path /home/M24_2/cadence_edt/HMK_VDA/mokesh_project_test_arbiter/dft_insertion_for_scan_chain/dft_input -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/M24_2/cadence_edt/HMK_VDA/mokesh_project_test_arbiter/dft_insertion_for_scan_chain/dft_input/rr_arbiter.v
elaborate_design -golden -root {rr_arbiter} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/rr_arbiter/fv_map.v.gz
elaborate_design -revised -root {rr_arbiter}
...
#add_name_alias fv/rr_arbiter/fv_map.singlebit.original_name.alias.json.gz -revised
...
#  2      rst_n                          test_mode        false      false       port        none                       false                 false         auto       
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
set_system_mode lec
write_compared_points noneq.compared_points.rr_arbiter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.rr_arbiter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.rr_arbiter.rtl.fv_map.rpt
